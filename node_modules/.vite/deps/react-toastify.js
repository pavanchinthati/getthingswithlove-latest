...
function useToast(props) {
  ...
  (0, import_react.useEffect)(function() {
    if (toastRef.current) toastRef.current.addEventListener(
      "d",
      playToast,
      {
        once: true
    ...
    return function() {
      ...
      if (isFn(props2.onClose)) props2.onClose((0, import_react.isValidElement)(props2.children) && props2.children.props);
    };
  }, []);
  (0, import_react.useEffect)(function() {
...
var Toast = function Toast2(props) {
  ...
  function renderCloseButton(closeButton2) {
    ...
    if ((0, import_react.isValidElement)(closeButton2)) return (0, import_react.cloneElement)(closeButton2, props2);
  }
